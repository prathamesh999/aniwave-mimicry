...
const Footer = () => {
  ...
  return (
    <footer className="py-16 px-6 md:px-12 border-t border-white/10 bg-black">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={item.name}>
                  <a href="#" className="text-white/70 hover:text-white transition-colors animated-underline flex items-center gap-2">
                    {item.icon}
                    {item.name}
                  </a>
                </li>
          ...
          <div>
            ...
            <form className="flex gap-2">
              <input
                ...
                className="px-4 py-2 rounded-md border border-white/10 bg-white/5 text-white flex-grow focus:outline-none focus:ring-1 focus:ring-white/30 transition-all"
              />
              <button
                type="submit"
                className="rounded-md bg-white text-black px-4 py-2 font-medium transition-all hover:bg-white/90"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-white/10">
          ...
          <div className="flex gap-6">
            {["Instagram", "TikTok", "Twitter", "Facebook"].map((social) => (
              <a key={social} href="#" className="text-white/60 hover:text-white transition-colors text-sm">
                {social}
              </a>
            ))}
          </div>
